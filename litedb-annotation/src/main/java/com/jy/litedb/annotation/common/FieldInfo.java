...
public class FieldInfo {
    ...
    public FieldInfo(String name, Class<?> type, boolean isPrimaryKey, boolean isAutoKey, boolean isUpdateField, int updateFieldVersion, boolean isFilter, boolean isCompareField) {
        this.name = name;
        this.type = type;
